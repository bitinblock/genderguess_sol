            ...
            <Col span="24">
                <Collapse v-model="value1" accordion>
                    <Panel name="1">
                        ...
                        <p slot="content">This is a simple gender guess game created by a soon-to-be dad. In order to participate one should have browser installed with metamask and a kind heart. 
                            ...
                            If you would like to increase the prize money by sending ETH to contract you are welcome to do so. <a href="" @click.stop.prevent="rewardCheck">Click here to increase reward.</a>
                    ...
                    <Panel name="3">
                        ...
                        <p slot="content">There is no financial benefit in this for us. 
                            The idea started with a small family game then thought when it can be opened to world through blockchain then why not be a part of the cause!
                        </p>
                    </Panel>
                    <Panel name="4">
                    ...
                    <Panel name="5">
                        ...
                        <p slot="content"> Yes. The game will be voided/canceled if there are less than 100 participants and also if number of participants in each gender pool is less than 30. In such scenario all the prize amount will be sent to the binance donation address.
                        </p>
                    </Panel>
                    <Panel name="6">
                    ...
                    <Panel name="7">
                        <span class="panel-header-text">Can you share symptoms of the mother-to-be ?</span>
                        <p slot="content">
                           Sure! 
                            <Row>
                                <Col span="24" offset="2">
                                    <ul>
                                        <li>She is in her third trimester now!</li>
                                        <li>She didnt show any morning sickness in her early days of pregnancy</li>
                                        <li>Baby heart beat is 140+</li>
                                    </ul>
                                </Col>
                            </Row>
                        </p>
                            ...
                            <Row>
                                <Col span="24" offset="2">
                                    <ul>
                                        ...
                                        <li>User Not on Mainnet</li>
                                        <li>User already participated</li>
                                    </ul>
                                </Col>
                            </Row>
                        </p>
                    ...
                    <Panel name="11">
                        <span class="panel-header-text">Where did you find these images from ?</span>
                        <p slot="content">
                            My sincere appreiciation to the original artists who created the images used in this website. The kids images are from artist <a href="http://www.iconarchive.com/show/baby-boy-icons-by-dapino.html">DaPino</a>.
                            The banner was found on Google Image search and was not able to identify the original creator.   
                        </p>
                    </Panel>
                    ...
                    <Modal v-model="modal3" width="360">
                        ...
                        <div style="text-align:center">
                            <p>Sorry the event is now closed and can't increase the reward.</p>
                        </div>
                    </Modal>
                </Collapse>
            </Col>
